/**
 * subscription product pdp - Item successfully added to cart as gift
 */
...
test.describe("subscription product pdp -> item successfully added to cart as gift", () => {
    ...
    test("add a product to the cart and verify the product title", async () => {
        await productDetailsPage.clickGiveAsAGift(testdata.giveAsaGifit)
        ...
        await cartPage.verifyEditGiftOptionInCartPage(productTilteInProductDetailPage)
        await cartPage.clickGiftOption(productTilteInProductDetailPage)
        await cartPage.verifyEditGiftOptionIsChecked()
        logGenerator.customLogger("verify gift option is checked")
        logGenerator.customLogger("product is added to the cart")
